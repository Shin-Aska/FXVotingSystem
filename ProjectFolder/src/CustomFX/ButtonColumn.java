 ...
 * @author richard
 */
public class ButtonColumn extends TableColumn implements VirtualColumn{
    
    private String symbol = "?";
    private EventHandler <ActionEvent> evt;
    
    public ButtonColumn(String columnName, String symbol, EventHandler <ActionEvent> evt) {
        super(columnName);
        this.symbol = symbol;
        this.evt = evt;
        initialize();
